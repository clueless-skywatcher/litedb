...
public class LTQLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "LETTERS", "DIGITS", "BOOLEAN_VALUE", "AND", 
			"CREATE", "DELETE", "DROP", "FROM", "IF", "INSERT", "INTO", "SELECT", 
			"SET", "TABLE", "UPDATE", "VALUES", "WHERE", "WITH", "EQ", "NEQ", "LT", 
	...
	public LTQLLexer(CharStream input) {
		super(input);
