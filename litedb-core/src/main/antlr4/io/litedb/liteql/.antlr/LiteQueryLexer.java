...
public class LiteQueryLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"CREATE", "DROP", "FROM", "IF", "INSERT", "INTO", "SELECT", "TABLE", 
			"VALUES", "WHERE", "WITH", "EQ", "NEQ", "LT", "LTE", "GT", "GTE", "PLUS", 
			"MINUS", "ASTERISK", "SLASH", "PERCENT", "CONCAT", "SEMICOLON", "STRING", 
			"INTEGER", "IDENTIFIER", "QUOTED_IDENTIFIER", "WS", "COMMENT"
		};
	}
